...
namespace VideoPlayer360
{
    ...
    public class ReticleMediaPlayer : MonoBehaviour, GazePointerMediaPlayer
    {
        ...
        void OnEnable()
        {
            GazeInputModuleMediaPlayer.gazePointer = this;
        }

        void OnDisable()
        {
            if ((Object)GazeInputModuleMediaPlayer.gazePointer == this)
            {
                GazeInputModuleMediaPlayer.gazePointer = null;
            }
        }
